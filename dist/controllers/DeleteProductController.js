...
var DeleteProductController = /** @class */ (function () {
    ...
    DeleteProductController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, deleteProductService, product;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = request.params.id;
                        deleteProductService = new DeleteProductService_1.DeleteProductService();
                        return [4 /*yield*/, deleteProductService.execute(id)];
                    case 1:
                        product = _a.sent();
