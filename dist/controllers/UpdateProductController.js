...
var UpdateProductController = /** @class */ (function () {
    ...
    UpdateProductController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, description, price, id, updateProductService, product;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, description = _a.description, price = _a.price;
                        id = request.params.id;
                        updateProductService = new UpdateProductService_1.UpdateProductService();
                        return [4 /*yield*/, updateProductService.execute({ id: id, name: name, description: description, price: price })];
                    case 1:
                        product = _b.sent();
