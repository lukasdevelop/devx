...
var AuthenticateUserService = /** @class */ (function () {
    ...
    AuthenticateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userRepositories, user, passwordMatch, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        userRepositories = typeorm_1.getCustomRepository(UsersRepositories_1.UsersRepositories);
                        return [4 /*yield*/, userRepositories.findOne({
                                email: email
                            })];
                    case 1:
                        user = _b.sent();
